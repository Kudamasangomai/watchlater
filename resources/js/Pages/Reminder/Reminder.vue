            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                >
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <table
                            class="min-w-full text-center divide-y divide-gray-200 dark:divide-gray-700"
                        >
                            <thead>
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a
                                            :href="`https://www.youtube.com/watch?v=${reminder.url}`"
                                            target="_blank"
                                            rel="noopener"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        {{ reminder.sent_at ? "Yes" : "No" }}
                                    </td>
                                    <!-- <td class="px-6 py-4 capitalize whitespace-nowrap">{{ reminder.status ? 'Not Yet Watched' : reminder.status }}</td> -->
                                    <td
                                        class="flex gap-2 px-6 py-4 whitespace-nowrap"
                                    >
                                        <Link
